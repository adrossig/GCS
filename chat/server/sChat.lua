...
---@param color rgb Color of the message in RGB format. Optional.
---@param args object Additional arguments, such as timeout or channel.
--[[
...
---@param color rgb Color of the message in RGB format. Optional.
---@param args object Additional arguments, such as timeout, channel, style, or use_name.
--[[/**
